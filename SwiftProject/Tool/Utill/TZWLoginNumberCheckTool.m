...
@implementation TZWLoginNumberCheckTool
...
{
    NSString *zoneNum = code;
    if ([code hasPrefix:@"+"]) {
        zoneNum = [zoneNum stringByReplacingOccurrencesOfString:@"+" withString:@""];
    }
    NSNumber *zoneNumber = [NSNumber numberWithInteger:[zoneNum integerValue]];
    return zoneNumber;
}
 ...
 * @return YES(含有表情)
 */
#pragma mark  判断字符串中是否存在emoji 限制第三方键盘
